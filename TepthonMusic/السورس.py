...
async def restart(client, m: Message):
    ...
    await noovaa.edit("8")
    await noovaa.edit("9")
    await noovaa.edit("**تم اعادة تشغيل سورس تيبثون ميوزك بنجاح ✓**")
...
- هلا ياطيب  {m.from_user.mention} ✫
                                   ​​​​​​​​​​​  ​​​​​​​​​​​​​​​​​​​​​​​​​​✫
قائمـة اوامر سـورس تيبثون مـيـوزك. ✫
                                   ​​​​​​​​​​​  ​​​​​​​​​​​​​​​​​​​​​​​​​​✫
- أوامر المستخدمين: 
                                   ​​​​​​​​​​​  ​​​​​​​​​​​​​✫
• {HNDLR}شغل
...
"""
    await martin.reply_photo(
        photo=f"https://telegra.ph/file/566e508eaa2549b2a794a.jpg",
        caption=REPZ,
    )
